...
try {
 ...
 //   $mail->SMTPDebug = SMTP::DEBUG_SERVER;                      //Enable verbose debug output
    ...
    $mail->Host       = 'mail.madredemisericordia.es';                     //Set the SMTP server to send through
    $mail->SMTPAuth   = true;                                   //Enable SMTP authentication
    $mail->Username   = 'itsupport@madredemisericordia.es';                     //SMTP username
    $mail->Password   = 'EsperanzayCaridad23';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;             //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('itsupport@madredemisericordia.es', 'MDM IT Support');
    $mail->addAddress('kirstin_castillo@hotmail.com', 'Process Customainze');     //Add a recipient RECEIVER
    //$mail->addAddress('ramonjoseph.c@gmail.com', 'Process Customainze');     //Add a recipient RECEIVER
    //$mail->addAddress('ellen@example.com');               //Name is optional
    //$mail->addReplyTo('info@example.com', 'Information');
    //$mail->addCC('cc@example.com');
    $mail->addBCC('ramonjoseph@protonmail.com');
    ...
    $mail->Body    = "Please process file  <b>Thanks from MDM team!</b> Ref : $refinvoice\n items : $item1 , $item2 , $item3 , $item4";
